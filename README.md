...
| `v0.3.0` | Timeline profesional: recortar audio, forma de onda, varias pistas de video | 🚧 Siguiente |
| `v0.4.0` | Color estilo Lumetri, texto e interfaz al estilo Premiere | Planificado |
